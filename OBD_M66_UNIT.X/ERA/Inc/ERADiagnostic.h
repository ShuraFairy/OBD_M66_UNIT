...
/* ŒÔËÒ‡ÌËÂ: ›–¿-√ÀŒÕ¿——							*/
/****************************************************/
#ifndef ERADIAGNOSTIC_H
#define	ERADIAGNOSTIC_H
...
extern __attribute__ ((far)) struct VehicleCoordinates 
{
...
extern __attribute__ ((far)) struct AccelerometerRawData
{
...
//****************************** Functions prototype ***************************
void initVariablesERADiagnostic(void); 
